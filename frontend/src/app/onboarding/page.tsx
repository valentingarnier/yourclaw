          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl shadow-zinc-900/5 border border-zinc-200">
            ...
            <div className="flex rounded-xl bg-zinc-100 p-1 mb-6">
              <button
                type="button"
                disabled
                className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium text-zinc-400 cursor-not-allowed opacity-50"
              >
                ...
                WhatsApp
                <span className="text-[10px] bg-amber-100 text-amber-600 px-1.5 py-0.5 rounded-full font-medium">Soon</span>
              </button>
              <button
                type="button"
